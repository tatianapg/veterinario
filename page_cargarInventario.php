...
if(isset($_GET["del"]) && $_GET["del"] == 1) {
	$texto = "Inventario eliminado: ";
} else
	$texto = "Inventario ingresado: ";

?>
<div id="marco">
  <div id="ladoIzquierdo"><?php echo($cadena) ;?>  
  </div>
  <div id="ladoDerecho"><?php echo($texto);?><a href="" onClick="return loadQueryResults('frmIngInventario.php?cdinv=<?php echo($_GET["cdinv"])?>');"><?php echo($_GET["nmi"] . " - " . $_GET["cdinv"])?></a></div>
</div>
</body>
</html>